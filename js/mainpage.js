...
$(document).ready(function() {
    ...
    $("#dconinfo-section, #countdown-section, #gallery-section, #elections-section, #register-section, #awards-section, #involvement-section, #location-section, #contact-section, #elections-section").hide();
